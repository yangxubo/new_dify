const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'RealityAI account',
    langGeniusAccountTip: 'Your RealityAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to RealityAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by RealityAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across RealityAI\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    // linkUrl: 'https://docs.dify.ai/advanced/api_based_extension',
    linkUrl: 'https://realityai.cc/docs/api-extension',
  ...
  about: {
    ...
    nowAvailable: 'RealityAI {{version}} is now available.',
    latestAvailable: 'RealityAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
